...
const Playground = () => {
  ...
  const handleCleanup = async () => {
    ...
    if (playGroundContainerIdRef.current) {
      try {
        console.log("Deleting playground:", playGroundContainerIdRef.current);
        await deletePlayGround({ containerId: playGroundContainerIdRef.current, projectId: playground.playGroundId });
      } catch (error) {
