...
const EditorComponent = ({ selectedFile, socket }) => {
    ...
    const updateCursor = useCallback(
        (userId, position) => {
            ...
            const newDecorations = Array.from(cursorsRef.current.entries()).map(
                ([id, pos]) => createCursorDecoration(id, pos)
            );
            console.log(
                'new Decorations',
                newDecorations,
            ...
            const appliedDecorations = editorRef.current.deltaDecorations(
                decorations,
                newDecorations
            );
