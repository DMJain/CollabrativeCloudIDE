...
const HomePage = () => {
    ...
    const handleClick = async (e) => {
        e.preventDefault();
        const { data } = await createPlayGround({
            image: 'reactbaseapp',
            name: name,
        });
    ...
    return (
        <div>
            <div className="flex justify-center items-center h-screen">
                <div className="h-2/3 border w-1/4 flex flex-col gap-2 p-2 rounded-lg border-neutral">
                    <div className="flex justify-between flex-col gap-2 border-b border-neutral p-2 w-full ">
                        {showCreateForm ? (
                            <CreateForm
                                name={name}
                                setName={setName}
                        ...
                        <div className="p-2 overflow-y-auto grid grid-cols-1 gap-2">
                            {projects &&
                                projects.map((project) => (
                                    <div
                                        key={project._id}
                                        className="flex justify-between p-2 items-center shadow-md hover:shadow-lg rounded-lg border"
                                    >
